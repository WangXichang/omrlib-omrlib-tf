...
class Model:
    ...
    def __init__(self):
        ...
        self.data_path = None
        self.save_model_path = self.model_name
    ...
    def train_model(self, data: Data, batch_num=40, train_num=1000):
        ...
        saver.save(sess, self.save_model_path + '.ckpt')

    def use_model(self, omr_image_data):
        # saver = tf.train.Saver()
        modelmeta = self.save_model_path + '.ckpt.meta'
        modelckpt = self.save_model_path + '.ckpt'
        tf.reset_default_graph()
...
class CnnApp:
    ...
    def __init__(self):
        self.model_path_office = 'f:/studies/juyunxia/omrmodel/omr_model'
        self.model_path_dell = 'd:/work/omrmodel/omr_model'
        self.model_path = self.model_path_dell
    ...
    def load_model(self, _model_path=''):
        ...
        with self.graph.as_default():
            ...
            self.saver.restore(self.sess, self.model_path + '.ckpt')
